...
//     * RecyclerView} is LTR, than it will layout from RTL, if {@link RecyclerView}} is RTL, it will
//     * layout from LTR.
//     */
...
//     * <p>
//     * When smooth scrollbar is disabled, the position and size of the scrollbar thumb is based solely
//     * on the number of items in the adapter and the position of the visible items inside the adapter.
//     * This provides a stable scrollbar as the user navigates through a list of items with varying
//     * widths / heights.
//     *
...
//                    mPendingScrollPosition * -mInterval : mPendingScrollPosition * mInterval;
//        }
//        Log.d("TAG", "mInterval == " + mInterval + "   mOffset ==   " + mOffset);
//
//        detachAndScrapAttachedViews(recycler);
//        layoutItems(recycler);
//    }
...
//        mOffset += realDx;
//
////        Log.d("TAG","targetOffset    " + targetOffset+"   mOffset == " + mOffset );
//
//        //handle recycle
//        layoutItems(recycler);
//
...
//        for (int i = start; i <= end; i++) {
//
//                int adapterPosition = Math.abs(i) % itemCount;
//                final View scrap = recycler.getViewForPosition(adapterPosition);
//                measureChildWithMargins(scrap, 0, 0);
//                resetViewProperty(scrap);
//                final float targetOffset = getProperty(i) - mOffset;
...
//    public int getOffsetToPosition(int position) {
//        if (mInfinite)
//            return (int) (((getCurrentPositionOffset() + (!mShouldReverseLayout ? position - getCurrentPosition() : getCurrentPosition() - position)) * mInterval - mOffset) * getDistanceRatio());
