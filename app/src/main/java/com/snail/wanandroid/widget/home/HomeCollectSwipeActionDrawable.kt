...
package com.snail.wanandroid.widget.home
...
import com.snail.wanandroid.extensions.themeColor
import com.snail.wanandroid.extensions.themeInterpolator
import com.snail.wanandroid.utils.lerp
import com.snail.wanandroid.utils.lerpArgb
import kotlin.math.abs
import kotlin.math.hypot
import kotlin.math.sin

class HomeCollectSwipeActionDrawable(context: Context) : Drawable() {
    ...
    private val icon = AppCompatResources.getDrawable(
        context,
        R.drawable.ic_home_favorite_32
    )!!
    private val iconMargin = context.resources.getDimension(R.dimen.x64)
